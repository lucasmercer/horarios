        ...
        try {
          ...
          import('../lib/validation').then(({ BackupSchema }) => {
            ...
            if (!validation.success) {
              ...
              setImportStatus('error');
              setImportMessage('O arquivo JSON está corrompido ou possui formato inválido. Falha na validação de segurança.');
              setIsImporting(false);
              return;
            }
            ...
            setImportMessage('Banco de dados restaurado com segurança! Os recursos do sistema foram atualizados e validados.');
            setIsImporting(false);
          }).catch(err => {
